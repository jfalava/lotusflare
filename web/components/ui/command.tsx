...
function CommandInput({
  ...
  React.useEffect(() => {
    if (isMobile && inputRef.current === document.activeElement) {
      // defer to next frame in case focus occurs slightly later
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        // run our nav handler, then preserve any passed‐in onKeyDown
        onKeyDown={(e) => {
          handleKeyDown(e);
          onKeyDown?.(e);
        }}
...
function CommandItem({
  ...
  const { onDismiss } = React.useContext(CommandContext);
  ...
  const handleSelect = React.useCallback(
    (value: string) => {
      ...
      // Auto-close parent dialog if it exists (from context)
      onDismiss?.();
    },
    [onSelect, onDismiss],
  );
